            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO eakari(customername,identity) values('$customername','$identity')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM eakari";
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            while($row=mysqli_fetch_array($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img height="40" width="50" src="<?php echo $row['identity']?>">
                                    </td>
<td>
                                        <a onclick="confirm('Do you want to remove it??')" class="btn btn-primary" href="delete(vkari).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
