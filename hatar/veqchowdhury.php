            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO eachowdhury(customername,memberpic,occupationplace) values('$customername','$memberpic','$occupationplace')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM eachowdhury";
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            while($row=mysqli_fetch_array($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img height="40" width="50" src="<?php echo $row['memberpic']?>">
                                    </td>
                                    <td>
                                        <?php echo $row['occupationplace']?>
                                    </td>
<td>
                                        <a  class="btn btn-primary" href="delete(vchowdhury).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
