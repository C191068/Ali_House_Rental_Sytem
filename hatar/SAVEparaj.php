    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                ...
                <div class="row">
                    <div class="column">
                        <a href="detailparaj.php" ><button type="button" class="btn btn-primary"><img height="50" width="50" src="bullet2.jpeg">View House Detail</button></a>
            ...
            <div>
                <center>
                    <img style="height:300px;width:70%;" src="bachelor(male2)(1).jpg">
                </center>
            </div>
            <div>
                <center>
