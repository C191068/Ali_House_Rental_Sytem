        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">Bachelor</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
<div class="scrolling-wrapper">
                    <a href="male%20admin.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="malemoney.jpeg">MALE</button>
                    </a>
                    <a href="female%20admin.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="600" src="femalemoney.jpeg">FEMALE</button>
                    </a>
</div>
                </div>
            </div>
