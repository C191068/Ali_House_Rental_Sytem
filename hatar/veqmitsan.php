            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO eamitsan(customername,identity) values('$customername','$identity')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM eamitsan";
...
<td>
                                        <a  class="btn btn-primary" href="delete(vmitsan).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
