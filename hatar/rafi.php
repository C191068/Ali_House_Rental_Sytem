...
<body bgcolor="green">
<center>
    <h1 class="glow">HOSELAND<br>A HOUSE RENTAL SYSTEM</h1>
</center>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">MD Rafdul Islam</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img style="width:30%;height:200px;" src="rafi.jpg">
                    </center>
                </div>
            </div>
            <center>
                <table>
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">MOBILE NO:01884213549</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">GENDER:MALE</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">DATE OF BIRTH:13th January 1994</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">EMAIL:houseland002@gmail.com</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">POSTAL CODE:5147</h1>
                        </td>
                    </tr>
