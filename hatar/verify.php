        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">Verify House Booked Customers</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                    <a href="verify family.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="verifyfamily.jpg">FAMILY HOUSE</button>
                    </a>
                    <a href="verify bachelor.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="veifybachelor.jpg">BACHELOR HOUSE</button>
                    </a>
                    </div>
                </div>
            </div>
