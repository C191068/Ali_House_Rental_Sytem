        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">AZZAK MANSION</h1>
                    </center>
                </div>
...
<a href="cashier1.php">
                    <button type="button" class="btn btn-primary">
                        <img height="50" width="50" src="icon.jpeg">Jashim Ali(cashier)</button>
</a>
                    <a href="detailazzak.php">
                        <button type="button" class="btn btn-primary">
