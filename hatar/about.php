        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">TEAM ABLAZE</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img class="rounded-circle" style="width:30%;height:200px;" src="Teamablaze.jpg">
                    </center>
                </div>
            </div>
            <center>
                <p> Team Ablaze is a beginner level software development team. It is trying the best to develop software that will be commercial and user friendly. The members working here are
                    <br>Ali Khatami
                    <br>MD Rafidul Islam </p>
            </center>
        </div>
    </div>
</div>
