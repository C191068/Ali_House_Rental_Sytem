        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR House Booking CONFIRMATION(KARI MANSION)</h1>
                    </center>
                </div>
<div>
                    <center>
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="Payment(kari).php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                           Bkash Personal Number(019632578)
                                        </td>
                                        <td>
                                            <input  class="form-control" name="bkash" id="bkash" value="019632578" readonly required autofocus placeholder="Enter the house owner bkash number">
                                        </td>
                                        <td>
...
<tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEkari.php')" class="btn btn-primary" name="submitButton" type="submit" value="CONFIRM Payment">
                                        </td>
                                    </tr>
                                </table>
                            </center>
