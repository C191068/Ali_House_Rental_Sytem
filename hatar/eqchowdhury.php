...
<head>
    <title>
        Information Required before booking(CHOWDHURY VILA)
    </title>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">Information Required before booking(Step 2)</h1>
                    </center>
                </div>
                <div>
                    <center>
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="veqchowdhury.php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required class="form-control" name="memberpic" id="memberpic" type="file">
                                        </td>
                                        <td>
                                            <img height="40" width="50" src="memberpic.png">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input  class="form-control" name="occupationplace" id="occupationplace"  placeholder="Enter your place of occupation">
                                        </td>
                                        <td>
                                            <img height="40" width="50" src="occupation.png">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('chowdhury2.php')" class="btn btn-primary" name="submitButton" type="submit" value="NEXT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
