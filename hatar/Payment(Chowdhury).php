...
$transaction=$_POST['transaction'];
                        ...
                        $insert_query="INSERT INTO chowdhury(customername,mobile,email,payment,bkash,transaction,ubkash) values('$customername','$mobile','$email','$payment','$bkash','$transaction','$ubkash')";
...
<td>
                                        <a  class="btn btn-primary" href="delete(paychowdhury).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
                                </tr>
