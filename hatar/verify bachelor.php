...
<div class="scrolling-wrapper">
                    <a href="verifymale.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="verifymale.jpeg">MALE</button>
                    </a>
                    <a href="verifyfemale.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="600" src="verifyfemale.png">FEMALE</button>
                    </a>
</div>
                </div>
            </div>
