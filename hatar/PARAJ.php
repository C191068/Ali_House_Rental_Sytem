        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR House booking CONFIRMATION(PARAJ VILA)</h1>
                    </center>
                </div>
<div>
                    <center>
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="Payment(PARAJ).php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
...
<tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEparaj.php')" class="btn btn-primary" name="submitButton" type="submit" value="CONFIRM payment">
                                        </td>
                                    </tr>
                                </table>
                            </center>
