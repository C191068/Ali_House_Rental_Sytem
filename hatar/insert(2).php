            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO signup(customername,mobile,gender,dateofBirth,picture,email,password,address,postalcode,religion,national) values('$customername','$mobile','$gender','$dateofBirth','$picture','$email','$password','$address','$postalcode','$religion','$national')";
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            while($row=mysqli_fetch_array($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img height="40" width="50" src="<?php echo $row['national']?>">
                                    </td>
                                    <td>
