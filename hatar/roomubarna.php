        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;"> UBARNA Mansions(DUPLEX)</h1>
                    </center>
                </div>
            ...
            <div class="wrapper">
                <a href="BED1.php"><img src="BED2.jpg" alt="bed-1"></a>
                ...
                <div class="wrapper">
                    <a href="Bed2.php"><img src="BED1.jpeg" alt="bed-1"></a>
                    <div id="left-door" class="door">
                        <div class="shape"></div>
                        <div class="shape"></div>
                        <div id="left-knob" class="knob"></div>
            ...
            <div class="column2">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="Bath1.php"><img src="Bath1.jpeg" alt="bath-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
                    ...
                    <div class="wrapper">
                        <a href="Bath2.php"><img src="Bath2.jpeg" alt="bath-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column3">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="Draw1.php"><img src="DRAW2.jpeg" alt="Draw-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
                        ...
                        <h3>Drawing Room 1</h3>

                    </div>
                    <div class="wrapper">
                        <a href="Draw2.php"><img src="DRAW1.jpeg" alt="draw-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
            ...
            <div class="column4">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="Din.php"><img src="DininG.jpeg" alt="DIN-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column5">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="kitchen.php"><img src="Kitchen.jpeg" alt="kitchen-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
                    ...
                    <div class="wrapper">
                        <a href="Balcony1.php"><img src="balcony1.jpeg" alt="balcony-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column6">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="balcony2.php"><img src="Balcony2.jpeg" alt="balcony-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
                    ...
                    <div class="wrapper">
                        <a href="stair.php"><img src="stairwell.jpeg" alt="stairwell-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column7">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="roof.php"><img src="rooftop.jpeg" alt="roof-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column8">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="read.php"><img src="read.jpeg" alt="read-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
...
<div class="column8">
                <section class="container">
                    ...
                    <div class="wrapper">
                        <a href="garage.php"><img src="garage.jpeg" alt="garage-1"></a>
                        <div id="left-door" class="door">
                            <div class="shape"></div>
                            <div class="shape"></div>
                            <div id="left-knob" class="knob"></div>
