            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO earahim(customername,memberpic,occupationplace) values('$customername','$memberpic','$occupationplace')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM earahim";
...
<td>
                                        <a  class="btn btn-primary" href="delete(vrahim).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
