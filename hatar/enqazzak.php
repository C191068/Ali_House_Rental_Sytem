...
<head>
    <title>
        Information Required before booking(AZZAK MANSION)
    </title>
            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="veqazzak.php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('azzak2.php')" class="btn btn-primary" name="submitButton" type="submit" value="NEXT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
