...
<head>
    <title>
        Detail of CHOWDHURY VILA(Quadplex)
    </title>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">CHOWDHURY VILA(Quadplex)</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img style="width:50%;height:400px;"class="rounded" src="quadplex-1.jpeg">
                    </center>
                </div>
            </div>
            <center>
                <table>
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">Amount:26000TK(per month)</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <img height="40" width="50" src="icon.jpeg">
                        </td>
                        <td>
                            <h1 style="color:red;font-size:40px;">Owner:Ali Khatami</h1>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <img height="40" width="50" src="bullet2.jpeg">
                        </td>
                        <td>
                            <h1 style="color:red;font-size:40px;">House No:6/6</h1>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <img height="40" width="50" src="rooms.png">
                        </td>
                        <td>
                            <h1 style="color:red;font-size:40px;">Virtual tour:<a href="roomchowdhury.php" class="btn btn-primary">Click here</a></h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">ADDRESS:South Khulshi,Chattogram,Bangladesh</h1>
                        </td>
                    </tr>
