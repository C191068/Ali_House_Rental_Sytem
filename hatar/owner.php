        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">OWNERS INFORMATION</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    ...
                    <a href="ali.php">
                        <button>
                            <img height="400" width="500" src="ali.jpg">Mr Ali</button>
                    </a>
                    <a href="khatami.php">
                        <button>
                            <img height="400" width="500" src="khatami.jpg">Mr Khatami</button>
                    </a>
                </div>
            </div>
        </div>
