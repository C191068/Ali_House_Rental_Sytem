            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO eajafar(customername,memberpic,occupationplace) values('$customername','$memberpic','$occupationplace')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM eajafar";
...
<td>
                                        <a  class="btn btn-primary" href="delete(vjafar).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
