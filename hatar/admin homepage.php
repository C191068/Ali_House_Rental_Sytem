        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-priamary" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">ADMIN HOME</h1>
                    </center>
                </div>
                <div class="row">
                    <div class="column">
                        <a href="adminlogin.php" target="_blank"><button type="button" class="btn btn-primary"><img height="50" width="50" src="admins.png">ADMIN SIGN IN</button></a>
                    </div>
                </div>
            </div>
            <div>
