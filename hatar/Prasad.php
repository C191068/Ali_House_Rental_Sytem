        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR House Booking Confirmation (PRASAD)</h1>
                    </center>
                </div>
<div>
                    <center>
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="Payment(Prasad).php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" name="payment" id="payment" value="3000" readonly required autofocus placeholder="Enter payment for confirmation">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            Bkash Personal Number(0179634456)
                                        </td>
                                        <td>
                                            <input  class="form-control" name="bkash" id="bkash" value="0179634456" readonly required autofocus placeholder="Enter the house owner bkash number">
                                        </td>
                                        <td>
...
<tr>
                                        ...
                                        <td>
                                            <input  class="form-control" name="ubkash" id="ubkash" placeholder="017xxxxxxxxxxx">
                                        </td>
                                        <td>
                                            <img height="40" width="50" src="bkash.jpg">
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEPrasad.php')" class="btn btn-primary" name="submitButton" type="submit" value="CONFIRM PAYMENT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
