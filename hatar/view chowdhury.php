        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">VIEW Limitations</h1>
                    </center>
                </div>
                <div>
                    <center>
                        <h1 style="color:red;font-size:40px;">Only four customers will be able to book this house for rent</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO wcchowdhury(customername,members,occupation) values('$customername','$members','$occupation')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM wcchowdhury";
