    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                ...
                <div>
                    <center>
                        <h1 style="color:red;font-size:40px;">Only Eight customers will be able to book this house for rent</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO wcmanshah(customername,university) values('$customername','$university')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM wcmanshah";
