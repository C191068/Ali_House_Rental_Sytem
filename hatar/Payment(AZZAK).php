...
<head>
    <title>
        Payment Complete(AZZAK MANSION)
    </title>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">Payment Complete(AZZAK MANSION)</h1>
                    </center>
                </div>
...
$transaction=$_POST['transaction'];
                        ...
                        $insert_query="INSERT INTO azzak(customername,mobile,email,payment,bkash,transaction,ubkash) values('$customername','$mobile','$email','$payment','$bkash','$transaction','$ubkash')";
                        $result=mysqli_query($connection,$insert_query);
                        $serial=1;
                        $select_query="SELECT * FROM azzak";
...
<td>
                                        <a  class="btn btn-primary" href="delete(payazzak).php?sl=<?php echo $row['sl']?>">DELETE</a>
                                    </td>
                                </tr>
