...
<head>
    <title>
        Information Required before booking(CHOWDHURY VILA(Quadplex))
    </title>
            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        <form action="view%20chowdhury.php" method="post" target="votar">
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input required class="form-control" name="customername" id="customername" value="<?php echo $_SESSION['customername'];?>" readonly required autofocus placeholder="Enter your name">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required class="form-control" name="occupation" id="occupation"  placeholder="Enter your occupation">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('picchowdhury.php')" class="btn btn-primary" name="submitButton" type="submit" value="NEXT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
