        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">CHOWDHURY VILA(Quadplex)</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <a href="ali.php">
                        <button type="button" class="btn btn-primary">
                            <img height="50" width="50" src="icon.jpeg">Ali Khatami(owner)</button>
                    </a>
<a href="">
                    <button type="button" class="btn btn-primary">
                        <img height="50" width="50" src="icon.jpeg">:Jafar Rahmat(cashier)</button>
                    </a>
                    <a href="detailchowdhury.php">
                        <button type="button" class="btn btn-primary">
...
<a href="myprofile.php"><button type="button" class="btn btn-danger"><img height="50" width="50" src="<?php echo $_SESSION['picture'];?>"><?php echo $_SESSION['customername'];?></button></a>
            ...
            <div>
                <center>
                    <a href="view%20chowdhury.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="watch%20family.jpeg">View<br>Limitations</button>
                    </a>
                    <a href="watch%20chowdhury.php">
                        <button type="button" class="btn btn-dark">
