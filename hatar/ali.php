        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">Ali Khatami</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img class="rounded-circle" style="width:30%;height:200px;" src="khatami.jpeg">
                    </center>
                </div>
            </div>
            <center>
                <table>
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">MOBILE NO:01830870273</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">DATE OF BIRTH:12th JUNE 1996</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">ADDRESS:10 NO WARD NORTH KATTALI,CHATTOGRAM,BANGLADESH</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">POSTAL CODE:4217</h1>
                        </td>
                    </tr>
