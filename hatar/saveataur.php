        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;"> ATAUR MANSION</h1>
                    </center>
                </div>
                <div class="row">
                    <div class="column">
                        <a href="detailataur.php" ><button type="button" class="btn btn-primary"><img height="50" width="50" src="bullet2.jpeg">View House Detail</button></a>
            ...
            <div>
                <center>
                    <img style="height:300px;width:70%;" src="bachelor(male5)(1).jpg">
                </center>
            </div>
            <div>
                <center>
