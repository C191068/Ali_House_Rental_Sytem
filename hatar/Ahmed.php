        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR HOUSE BOOKING CONFIRMATION(AHMED MANSION)</h1>
                    </center>
                </div>
 <div>
                    <center>
                            ...
                            <center>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" name="payment" id="payment" value="2000" readonly required autofocus placeholder="Enter payment for confirmation">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            Bkash Personal Number(0181567894)
                                        </td>
                                        <td>
                                            <input  class="form-control" name="bkash" id="bkash" value="0181567894" readonly required autofocus placeholder="Enter the house owner bkash number">
                                        </td>
                                        <td>
...
<tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('saveahmed.php')" class="btn btn-primary" name="submitButton" type="submit" value="CONFIRM PAYMENT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
