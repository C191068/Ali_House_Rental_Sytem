        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">ASSALAMUALIKUM,<?php echo $_SESSION['name'];?></h1>
                    </center>
                </div>
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">WELCOME TO ADMIN PANEL</h1>
                    </center>
                </div>
...
<div class="scrolling-wrapper">
                    <a href="insert(2).php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="tennnants.png">View<br>Registered Customers</button>
                    </a>
<a href="verify.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="verification.png">Verify<br>House Booked Customers</button>
                    </a>
                    <a href="housemanage.php">
                        <button type="button" class="btn btn-dark">
                            <img height="400" width="500" src="tenatpayment.jpeg">View<br>House Booking Confirmation Payment</button>
                    </a>
</div>
                </div>
            </div>
