        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">AHMED MANSION(Duplex)</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img style="width:50%;height:400px;"class="rounded" src="duplex-1.jpeg">
                    </center>
                </div>
            </div>
            <center>
                <table>
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">Amount:10000TK(per month)</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">House No:1/6</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">Virtual Tour:<a href="roomahmed.php" class="btn btn-primary">Click here</a></h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
